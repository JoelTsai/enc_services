...
#define FC_MAX_NUM_INITIATORS		0x100	// it's 0x100 for 929 and 0x200 for 929X
#define FC_MAX_LOGGEDIN_DEVICES	FC_MAX_NUM_INITIATORS
#define FC_MAX_FRAME_SIZE			0x800
#define FC_MAX_KNOWN_INITIATOR	200
#define FC_MAX_FRIENDLY_NAME_LENGTH	32
...
#define MPI_FCPORTPAGE_EXT_OPTION1_LOS        (0x02)
    ...
    u8                      Reserved7[3];
    u8                      CC_EXT;
}__attribute__ ((packed))  FC_ConfigPage_SFP_t,  FC_VENDOR_SFP_t, micFCConfigPage_Status_SFP_t;
...
#define MPI_FCPORTPAGE_FLAGS_ATTACH_PUBLIC_LOOP        (0x00000800)
    ...
    u8                      MaxFailOverPorts;		// max number of possible alias
    u8                      ReservedBytes[3];
    u64                     WWNN;                               // own WWNN
    u64                     WWPN;                               // own WWPN
...
//===================================================================
typedef struct FC_INFO_DESC		//[ABC] same as FD_INFO_DESC
{
    u16 Type;
    u16 PortID;
    u16 Index;
...
/*
 * $Log: fc_mic_exp.h,v $
 * Revision 1.5  2006/04/03 23:57:57  debinc
 * dual controller fc
 *
 * Revision 1.4  2006/04/01 01:05:11  debinc
 * dual controller fc
 *
 * Revision 1.3  2006/01/14 00:40:59  debinc
 * 4Gb/s support
 *
 * Revision 1.2  2005/05/20 23:09:31  debinc
 * FC MIC change
 *
 * Revision 1.1  2005/02/19 02:06:53  debinc
 * M500f support
 *
