...
namespace OpenLibSys
{
    public class Ols : IDisposable
    {
        ...
        // I/O
        //-----------------------------------------------------------------------------
        public delegate byte _ReadIoPortByte(uint port);
        ...
        public delegate void _WriteIoPortByte(uint port, byte value);
        ...
        public delegate void _WritePciConfigDword(uint pciAddress, uint regAddress, uint value);
